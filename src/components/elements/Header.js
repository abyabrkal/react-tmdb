...
const Header = () => (
    <div className="box-border px-0 py-5">
        <div className="max-w-screen-xl min-h-48 px-5 py-0 mx-0 my-auto box-border sm:m-w-screen-xl sm:min-h-0">
            <img className="inline-block mx-0 w-32 sm:mt-2 sm:w-56" src={MoveeLogo} alt="movie-logo" />
            <img className="w-20 mt-6 sm:inline-block sm:mt-16 sm:w-24 float-right inline-block" src={TMDBlogo} alt="tmdb-logo" />
        </div>
    </div>
)
